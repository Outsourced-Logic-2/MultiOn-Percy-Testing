...
PercyScript.run(async (page, percySnapshot) => {
  try {
    ...
    console.log('Navigating to the Privacy Policy page...');
    await page.goto('https://www.multion.ai/privacy', { waitUntil: 'networkidle2' });
    console.log('Privacy Policy page navigation complete.');
    await waitForImagesToLoad(page);
    await triggerLazyLoading(page);
    console.log('Taking Percy snapshot for Privacy Policy page...');
    await percySnapshot('Privacy Policy Page Snapshot');
    console.log('Privacy Policy page snapshot taken.');

    // Visit the Terms of Service page
    console.log('Navigating to the Terms of Service page...');
    await page.goto('https://www.multion.ai/terms', { waitUntil: 'networkidle2' });
    console.log('Terms of Service page navigation complete.');
    await waitForImagesToLoad(page);
    await triggerLazyLoading(page);
    console.log('Taking Percy snapshot for Terms of Service page...');
    await percySnapshot('Terms of Service Page Snapshot');
    console.log('Terms of Service page snapshot taken.');
